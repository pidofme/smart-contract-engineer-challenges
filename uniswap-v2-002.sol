...
contract UniswapV2MultiHopSwap {
    ...
    function swapMultiHopExactAmountOut(
        ...
        // swapTokensForExactTokens returns an array of uint, amounts. Amount of DAI spent is stored in amounts[0].
        uint[] memory amounts = router.swapTokensForExactTokens(amountOutDesired, 
            amountInMax, path, msg.sender, block.timestamp);
